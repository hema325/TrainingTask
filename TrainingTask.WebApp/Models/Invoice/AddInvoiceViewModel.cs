...
namespace TrainingTask.WebApp.Models.Invoice
{
    public class AddInvoiceViewModel: IMapFrom<Entities.Invoice>, IMapTo<Entities.Invoice>
    {
        ...
        [Range(0, 9999999.99, ErrorMessage = "Price Must Be Positive Number")]
