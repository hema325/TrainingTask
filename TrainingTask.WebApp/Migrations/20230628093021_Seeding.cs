    ...
    public partial class Seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 6, 28, 12, 30, 21, 90, DateTimeKind.Local).AddTicks(9630), 3m, 1, "3657710996", 100m, 300m, 3 },
                    { 2, 2, new DateTime(2022, 6, 28, 12, 30, 21, 90, DateTimeKind.Local).AddTicks(9715), 8m, 2, "2196613588", 200m, 600m, 1 },
                    { 3, 1, new DateTime(2025, 6, 28, 12, 30, 21, 90, DateTimeKind.Local).AddTicks(9721), 13m, 2, "2511516670", 50m, 600m, 2 }
                });
        }
