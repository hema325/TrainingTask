...
$(function () {
        ...
        for (let i = 0; i < items.length; ++i) {
            $("table tbody").append(`
             <tr>
                ...
                <td>
                    <a href="/types/details/${items[i].id}" class="btn btn-secondary p-1">Details</a>
                    <a href="/types/edit/${items[i].id}" class="btn btn-primary p-1">Edit</a>
    ...
    function load() {
        ...
        $.ajax({
            url: `/types/get?page=${pageNumber}&size=${pageSize}`,
            type: "get",
